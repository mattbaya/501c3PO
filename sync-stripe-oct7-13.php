<?php
/**
 * Sync Stripe for Oct 7-13, 2025
 * Uses correct swca_options table
 */

$passphrase = 'POBox432';
$days_back = 7; // Last 7 days to catch Oct 7-13
...
echo "=== STRIPE SYNC (OCT 7-13, 2025) ===\n\n";

// Get organization settings from CORRECT table (swca_options, not wp_options)
